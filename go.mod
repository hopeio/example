...
require (
	...
	github.com/hopeio/cherry v1.16.12
	github.com/hopeio/context v0.0.25
	github.com/hopeio/initialize v0.0.25
	github.com/hopeio/pick v1.6.6
	github.com/hopeio/protobuf v0.0.26
	github.com/hopeio/utils v0.0.30
